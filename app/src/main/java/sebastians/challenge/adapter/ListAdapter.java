 ...
 */
public abstract class ListAdapter<T> extends ArrayAdapter<T> implements PinnedSectionListView.PinnedSectionListAdapter {
    ...
    public ListAdapter(Context context, int resource, int resourceHeader, List<T> objects) {
